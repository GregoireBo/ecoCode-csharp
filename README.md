...
This
SonarQube plugin then implements these catalogs as rules for scanning your C# projects.
...
Ready to use binaries are available [from GitHub](https://github.com/green-code-initiative/ecoCode-csharp/releases).
